module.exports = function(){
    return {
        ...
        products: [
            ...
            { id: 2, name: "LifeJacket", category: "Watersports", description: "Protective and fashionable", price: 275 },
            ...
            { id: 5, name: "Staduim", category: "Soccer", description: "Flat-packed 35,000-seat staduim", price: 79500 },
            { id: 6, name: "Thinking Cap", category: "Chess", description: "Improve brain effeciency by 75%", price: 16 },
            ...
            { id: 9, name: "Bling Bling King", category: "Chess", description: "Gold-plated, diamond-studded King", price: 75 }
        ],
        orders: []
    }
}